...
class PortfolioController extends AbstractController
{
    ...
    /**
     * @Route("X/{id}/symbols", name="Xportfolio_symbols", methods={"GET"})
     */
...
//                'currencies' => $baserate,
    ...
    /**
     * @Route("/{portfolio}/stock/{stock}/dashboard", name="portfolio_stock_dashboard", methods={"GET"}, requirements={"portfolio":"\d+", "stock":"\d+"})
