 ...
 */
final class Version20210527103721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__option AS SELECT id, stock_id, call_or_put, strike, last_trade_date, multiplier, api_req_id FROM option');
        $this->addSql('DROP TABLE option');
        $this->addSql('CREATE TABLE option (id INTEGER NOT NULL, stock_id INTEGER NOT NULL, call_or_put VARCHAR(1) NOT NULL COLLATE BINARY, strike DOUBLE PRECISION NOT NULL, last_trade_date DATE NOT NULL, multiplier INTEGER NOT NULL, api_req_id INTEGER DEFAULT NULL, implied_volatility DOUBLE PRECISION DEFAULT NULL, delta DOUBLE PRECISION DEFAULT NULL, pv_dividend DOUBLE PRECISION DEFAULT NULL, gamma DOUBLE PRECISION DEFAULT NULL, vega DOUBLE PRECISION DEFAULT NULL, theta DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_5A8600B0DCD6110 FOREIGN KEY (stock_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A8600B0BF396750 FOREIGN KEY (id) REFERENCES contract (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO option (id, stock_id, call_or_put, strike, last_trade_date, multiplier, api_req_id) SELECT id, stock_id, call_or_put, strike, last_trade_date, multiplier, api_req_id FROM __temp__option');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_BE94B39E2576E0FD ON open_order (contract_id)');
        $this->addSql('DROP INDEX IDX_5A8600B0DCD6110');
        $this->addSql('CREATE TEMPORARY TABLE __temp__option AS SELECT id, stock_id, last_trade_date, strike, call_or_put, multiplier, api_req_id FROM option');
        $this->addSql('DROP TABLE option');
        $this->addSql('CREATE TABLE option (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, stock_id INTEGER NOT NULL, last_trade_date DATE NOT NULL, strike DOUBLE PRECISION NOT NULL, call_or_put VARCHAR(1) NOT NULL, multiplier INTEGER NOT NULL, api_req_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO option (id, stock_id, last_trade_date, strike, call_or_put, multiplier, api_req_id) SELECT id, stock_id, last_trade_date, strike, call_or_put, multiplier, api_req_id FROM __temp__option');
        $this->addSql('DROP TABLE __temp__option');
        $this->addSql('CREATE INDEX IDX_5A8600B0DCD6110 ON option (stock_id)');
        $this->addSql('DROP INDEX IDX_66F58DA0727ACA70');
        $this->addSql('DROP INDEX IDX_66F58DA0C4663E4');
