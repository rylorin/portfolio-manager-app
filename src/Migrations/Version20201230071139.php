 ...
 */
final class Version20201230071139 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fee_statement (id INTEGER NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__classification__context AS SELECT id, name, enabled, created_at, updated_at FROM classification__context');
        $this->addSql('DROP TABLE classification__context');
        $this->addSql('CREATE TABLE classification__context (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, enabled BOOLEAN NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO classification__context (id, name, enabled, created_at, updated_at) SELECT id, name, enabled, created_at, updated_at FROM __temp__classification__context');
        $this->addSql('DROP TABLE __temp__classification__context');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__comment AS SELECT id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private FROM comment__comment');
        $this->addSql('DROP TABLE comment__comment');
        $this->addSql('CREATE TABLE comment__comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, thread_id INTEGER DEFAULT NULL, body CLOB NOT NULL COLLATE BINARY, ancestors VARCHAR(1024) NOT NULL COLLATE BINARY, depth INTEGER NOT NULL, created_at DATETIME NOT NULL, state INTEGER NOT NULL, author_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, website VARCHAR(255) DEFAULT NULL COLLATE BINARY, note DOUBLE PRECISION DEFAULT NULL, private BOOLEAN DEFAULT NULL, CONSTRAINT FK_FD78D017E2904019 FOREIGN KEY (thread_id) REFERENCES comment__thread (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comment__comment (id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private) SELECT id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private FROM __temp__comment__comment');
        ...
        $this->addSql('DROP INDEX IDX_3B60C91012469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__thread AS SELECT id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM comment__thread');
        $this->addSql('DROP TABLE comment__thread');
        $this->addSql('CREATE TABLE comment__thread (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER DEFAULT NULL, permalink VARCHAR(255) NOT NULL COLLATE BINARY, is_commentable BOOLEAN NOT NULL, num_comments INTEGER NOT NULL, last_comment_at DATETIME DEFAULT NULL, average_note DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_3B60C91012469DE2 FOREIGN KEY (category_id) REFERENCES classification__category (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comment__thread (id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note) SELECT id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM __temp__comment__thread');
        $this->addSql('DROP TABLE __temp__comment__thread');
        $this->addSql('CREATE INDEX IDX_3B60C91012469DE2 ON comment__thread (category_id)');
        $this->addSql('DROP INDEX UNIQ_E98F2859ECC836F9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__contract AS SELECT id, secType, con_id, symbol, exchange, price, currency, name, fifty_two_week_low, fifty_two_week_high, bid, ask, previous_close_price FROM contract');
        $this->addSql('DROP TABLE contract');
        $this->addSql('CREATE TABLE contract (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, secType VARCHAR(4) NOT NULL COLLATE BINARY, con_id INTEGER DEFAULT NULL, symbol VARCHAR(19) NOT NULL COLLATE BINARY, exchange VARCHAR(8) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) NOT NULL COLLATE BINARY, name VARCHAR(31) DEFAULT NULL COLLATE BINARY, fifty_two_week_low DOUBLE PRECISION DEFAULT NULL, fifty_two_week_high DOUBLE PRECISION DEFAULT NULL, bid DOUBLE PRECISION DEFAULT NULL, ask DOUBLE PRECISION DEFAULT NULL, previous_close_price DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO contract (id, secType, con_id, symbol, exchange, price, currency, name, fifty_two_week_low, fifty_two_week_high, bid, ask, previous_close_price) SELECT id, secType, con_id, symbol, exchange, price, currency, name, fifty_two_week_low, fifty_two_week_high, bid, ask, previous_close_price FROM __temp__contract');
        $this->addSql('DROP TABLE __temp__contract');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E98F2859ECC836F9 ON contract (symbol)');
        ...
        $this->addSql('DROP INDEX idx_option_all');
        $this->addSql('DROP INDEX idx_option_stock');
        $this->addSql('DROP INDEX IDX_5A8600B0DCD6110');
        $this->addSql('CREATE TEMPORARY TABLE __temp__option AS SELECT id, stock_id, call_or_put, strike, last_trade_date, multiplier FROM option');
        $this->addSql('DROP TABLE option');
        $this->addSql('CREATE TABLE option (id INTEGER NOT NULL, stock_id INTEGER NOT NULL, call_or_put VARCHAR(1) NOT NULL COLLATE BINARY, strike DOUBLE PRECISION NOT NULL, last_trade_date DATE NOT NULL, multiplier INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_5A8600B0DCD6110 FOREIGN KEY (stock_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A8600B0BF396750 FOREIGN KEY (id) REFERENCES contract (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO option (id, stock_id, call_or_put, strike, last_trade_date, multiplier) SELECT id, stock_id, call_or_put, strike, last_trade_date, multiplier FROM __temp__option');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__position AS SELECT id, contract_id, portfolio_id, cost, quantity, open_date FROM position');
        $this->addSql('DROP TABLE position');
        $this->addSql('CREATE TABLE position (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contract_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, cost DOUBLE PRECISION DEFAULT NULL, quantity INTEGER NOT NULL, open_date DATE NOT NULL, CONSTRAINT FK_462CE4F5B96B5643 FOREIGN KEY (portfolio_id) REFERENCES portfolio (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_462CE4F52576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO position (id, contract_id, portfolio_id, cost, quantity, open_date) SELECT id, contract_id, portfolio_id, cost, quantity, open_date FROM __temp__position');
        ...
        $this->addSql('DROP INDEX statement_contract_portolio_date');
        $this->addSql('DROP INDEX IDX_C0DB5176B96B5643');
        $this->addSql('DROP INDEX IDX_C0DB5176DCD6110');
        $this->addSql('CREATE TEMPORARY TABLE __temp__statement AS SELECT id, portfolio_id, stock_id, statement_type, date, currency, description, amount FROM statement');
        $this->addSql('DROP TABLE statement');
        $this->addSql('CREATE TABLE statement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER NOT NULL, stock_id INTEGER DEFAULT NULL, statement_type VARCHAR(4) NOT NULL COLLATE BINARY, date DATETIME NOT NULL, currency VARCHAR(3) NOT NULL COLLATE BINARY, description VARCHAR(64) DEFAULT NULL COLLATE BINARY, amount DOUBLE PRECISION NOT NULL, CONSTRAINT FK_C0DB5176B96B5643 FOREIGN KEY (portfolio_id) REFERENCES portfolio (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C0DB5176DCD6110 FOREIGN KEY (stock_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO statement (id, portfolio_id, stock_id, statement_type, date, currency, description, amount) SELECT id, portfolio_id, stock_id, statement_type, date, currency, description, amount FROM __temp__statement');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__stock AS SELECT id, dividend_ttm, eps_ttm, eps_forward, description FROM stock');
        $this->addSql('DROP TABLE stock');
        $this->addSql('CREATE TABLE stock (id INTEGER NOT NULL, dividend_ttm DOUBLE PRECISION DEFAULT NULL, eps_ttm DOUBLE PRECISION DEFAULT NULL, eps_forward DOUBLE PRECISION DEFAULT NULL, description VARCHAR(31) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_4B365660BF396750 FOREIGN KEY (id) REFERENCES contract (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO stock (id, dividend_ttm, eps_ttm, eps_forward, description) SELECT id, dividend_ttm, eps_ttm, eps_forward, description FROM __temp__stock');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade AS SELECT id, comment, price, quantity, proceeds, fees, realized_pnl FROM trade');
        $this->addSql('DROP TABLE trade');
        $this->addSql('CREATE TABLE trade (id INTEGER NOT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, quantity DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_7E1A4366BF396750 FOREIGN KEY (id) REFERENCES statement (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade (id, comment, price, quantity, proceeds, fees, realized_pnl) SELECT id, comment, price, quantity, proceeds, fees, realized_pnl FROM __temp__trade');
        $this->addSql('DROP TABLE __temp__trade');
        $this->addSql('DROP INDEX IDX_63AFBEA22576E0FD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_option AS SELECT id, contract_id, proceeds, fees, quantity, realized_pnl, comment, price FROM trade_option');
        $this->addSql('DROP TABLE trade_option');
        $this->addSql('CREATE TABLE trade_option (id INTEGER NOT NULL, contract_id INTEGER NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, quantity DOUBLE PRECISION NOT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_63AFBEA22576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_63AFBEA2BF396750 FOREIGN KEY (id) REFERENCES statement (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade_option (id, contract_id, proceeds, fees, quantity, realized_pnl, comment, price) SELECT id, contract_id, proceeds, fees, quantity, realized_pnl, comment, price FROM __temp__trade_option');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__classification__category AS SELECT id, parent_id, context, media_id, name, enabled, slug, description, position, created_at, updated_at FROM classification__category');
        $this->addSql('DROP TABLE classification__category');
        $this->addSql('CREATE TABLE classification__category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, media_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, position INTEGER DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, context VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO classification__category (id, parent_id, context, media_id, name, enabled, slug, description, position, created_at, updated_at) SELECT id, parent_id, context, media_id, name, enabled, slug, description, position, created_at, updated_at FROM __temp__classification__category');
        $this->addSql('DROP TABLE __temp__classification__category');
        $this->addSql('CREATE INDEX IDX_43629B36727ACA70 ON classification__category (parent_id)');
        $this->addSql('CREATE INDEX IDX_43629B36E25D857E ON classification__category (context)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__classification__collection AS SELECT id, context, media_id, name, enabled, slug, description, created_at, updated_at FROM classification__collection');
        $this->addSql('DROP TABLE classification__collection');
        $this->addSql('CREATE TABLE classification__collection (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, media_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, context VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO classification__collection (id, context, media_id, name, enabled, slug, description, created_at, updated_at) SELECT id, context, media_id, name, enabled, slug, description, created_at, updated_at FROM __temp__classification__collection');
        $this->addSql('DROP TABLE __temp__classification__collection');
        $this->addSql('CREATE INDEX IDX_A406B56AE25D857E ON classification__collection (context)');
        $this->addSql('CREATE INDEX IDX_A406B56AEA9FDD75 ON classification__collection (media_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__classification__context AS SELECT id, name, enabled, created_at, updated_at FROM classification__context');
        $this->addSql('DROP TABLE classification__context');
        $this->addSql('CREATE TABLE classification__context (id VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO classification__context (id, name, enabled, created_at, updated_at) SELECT id, name, enabled, created_at, updated_at FROM __temp__classification__context');
        $this->addSql('DROP TABLE __temp__classification__context');
        $this->addSql('DROP INDEX IDX_CA57A1C7E25D857E');
        $this->addSql('DROP INDEX tag_context');
        $this->addSql('CREATE TEMPORARY TABLE __temp__classification__tag AS SELECT id, context, name, enabled, slug, created_at, updated_at FROM classification__tag');
        $this->addSql('DROP TABLE classification__tag');
        $this->addSql('CREATE TABLE classification__tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, context VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO classification__tag (id, context, name, enabled, slug, created_at, updated_at) SELECT id, context, name, enabled, slug, created_at, updated_at FROM __temp__classification__tag');
        $this->addSql('DROP TABLE __temp__classification__tag');
        $this->addSql('CREATE INDEX IDX_CA57A1C7E25D857E ON classification__tag (context)');
        $this->addSql('CREATE UNIQUE INDEX tag_context ON classification__tag (slug, context)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__comment AS SELECT id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private FROM comment__comment');
        $this->addSql('DROP TABLE comment__comment');
        $this->addSql('CREATE TABLE comment__comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, body CLOB NOT NULL, ancestors VARCHAR(1024) NOT NULL, depth INTEGER NOT NULL, created_at DATETIME NOT NULL, state INTEGER NOT NULL, author_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, note DOUBLE PRECISION DEFAULT NULL, private BOOLEAN DEFAULT NULL, thread_id VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO comment__comment (id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private) SELECT id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private FROM __temp__comment__comment');
        $this->addSql('DROP TABLE __temp__comment__comment');
        $this->addSql('CREATE INDEX IDX_FD78D017E2904019 ON comment__comment (thread_id)');
        $this->addSql('DROP INDEX IDX_3B60C91012469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__thread AS SELECT id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM comment__thread');
        $this->addSql('DROP TABLE comment__thread');
        $this->addSql('CREATE TABLE comment__thread (id VARCHAR(255) NOT NULL COLLATE BINARY, category_id INTEGER DEFAULT NULL, permalink VARCHAR(255) NOT NULL, is_commentable BOOLEAN NOT NULL, num_comments INTEGER NOT NULL, last_comment_at DATETIME DEFAULT NULL, average_note DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO comment__thread (id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note) SELECT id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM __temp__comment__thread');
        $this->addSql('DROP TABLE __temp__comment__thread');
        $this->addSql('CREATE INDEX IDX_3B60C91012469DE2 ON comment__thread (category_id)');
        $this->addSql('ALTER TABLE contract ADD COLUMN change_percent DOUBLE PRECISION DEFAULT NULL');
        $this->addSql('CREATE TEMPORARY TABLE __temp__dividend AS SELECT id, country FROM dividend');
        $this->addSql('DROP TABLE dividend');
        ...
        $this->addSql('CREATE INDEX IDX_682B2051BAD26311 ON news__post_tag (tag_id)');
        $this->addSql('DROP INDEX IDX_5A8600B0DCD6110');
        $this->addSql('CREATE TEMPORARY TABLE __temp__option AS SELECT id, stock_id, last_trade_date, strike, call_or_put, multiplier FROM option');
        $this->addSql('DROP TABLE option');
        $this->addSql('CREATE TABLE option (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, stock_id INTEGER NOT NULL, last_trade_date DATE NOT NULL, strike DOUBLE PRECISION NOT NULL, call_or_put VARCHAR(1) NOT NULL, multiplier INTEGER NOT NULL)');
        $this->addSql('INSERT INTO option (id, stock_id, last_trade_date, strike, call_or_put, multiplier) SELECT id, stock_id, last_trade_date, strike, call_or_put, multiplier FROM __temp__option');
        $this->addSql('DROP TABLE __temp__option');
        $this->addSql('CREATE INDEX IDX_5A8600B0DCD6110 ON option (stock_id)');
        $this->addSql('CREATE INDEX idx_option_all ON option (stock_id, last_trade_date, strike, call_or_put)');
        $this->addSql('CREATE INDEX idx_option_stock ON option (stock_id, last_trade_date)');
        $this->addSql('DROP INDEX IDX_66F58DA0727ACA70');
        $this->addSql('DROP INDEX IDX_66F58DA0C4663E4');
        ...
        $this->addSql('DROP TABLE position');
        $this->addSql('CREATE TABLE position (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER DEFAULT NULL, contract_id INTEGER NOT NULL, open_date DATE NOT NULL, quantity INTEGER NOT NULL, cost DOUBLE PRECISION DEFAULT NULL)');
        ...
        $this->addSql('DROP INDEX IDX_C0DB5176B96B5643');
        $this->addSql('DROP INDEX IDX_C0DB5176DCD6110');
        $this->addSql('CREATE TEMPORARY TABLE __temp__statement AS SELECT id, portfolio_id, stock_id, date, currency, amount, description, statement_type FROM statement');
        $this->addSql('DROP TABLE statement');
        $this->addSql('CREATE TABLE statement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER NOT NULL, stock_id INTEGER DEFAULT NULL, date DATETIME NOT NULL, currency VARCHAR(3) NOT NULL, amount DOUBLE PRECISION NOT NULL, description VARCHAR(64) DEFAULT NULL, statement_type VARCHAR(4) NOT NULL)');
        $this->addSql('INSERT INTO statement (id, portfolio_id, stock_id, date, currency, amount, description, statement_type) SELECT id, portfolio_id, stock_id, date, currency, amount, description, statement_type FROM __temp__statement');
        $this->addSql('DROP TABLE __temp__statement');
        $this->addSql('CREATE INDEX IDX_C0DB5176B96B5643 ON statement (portfolio_id)');
        $this->addSql('CREATE INDEX IDX_C0DB5176DCD6110 ON statement (stock_id)');
        $this->addSql('CREATE INDEX statement_contract_portolio_date ON statement (stock_id, portfolio_id, date)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__stock AS SELECT id, dividend_ttm, eps_ttm, eps_forward, description FROM stock');
        $this->addSql('DROP TABLE stock');
        $this->addSql('CREATE TABLE stock (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dividend_ttm DOUBLE PRECISION DEFAULT NULL, eps_ttm DOUBLE PRECISION DEFAULT NULL, eps_forward DOUBLE PRECISION DEFAULT NULL, description VARCHAR(31) DEFAULT NULL)');
        $this->addSql('INSERT INTO stock (id, dividend_ttm, eps_ttm, eps_forward, description) SELECT id, dividend_ttm, eps_ttm, eps_forward, description FROM __temp__stock');
        $this->addSql('DROP TABLE __temp__stock');
        $this->addSql('CREATE TEMPORARY TABLE __temp__tax AS SELECT id, country FROM tax');
        $this->addSql('DROP TABLE tax');
        ...
        $this->addSql('INSERT INTO tax (id, country) SELECT id, country FROM __temp__tax');
        $this->addSql('DROP TABLE __temp__tax');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade AS SELECT id, quantity, price, proceeds, fees, realized_pnl, comment FROM trade');
        $this->addSql('DROP TABLE trade');
        $this->addSql('CREATE TABLE trade (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO trade (id, quantity, price, proceeds, fees, realized_pnl, comment) SELECT id, quantity, price, proceeds, fees, realized_pnl, comment FROM __temp__trade');
        $this->addSql('DROP TABLE __temp__trade');
        $this->addSql('DROP INDEX IDX_63AFBEA22576E0FD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_option AS SELECT id, contract_id, quantity, price, proceeds, fees, realized_pnl, comment FROM trade_option');
        $this->addSql('DROP TABLE trade_option');
        $this->addSql('CREATE TABLE trade_option (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contract_id INTEGER NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO trade_option (id, contract_id, quantity, price, proceeds, fees, realized_pnl, comment) SELECT id, contract_id, quantity, price, proceeds, fees, realized_pnl, comment FROM __temp__trade_option');
        $this->addSql('DROP TABLE __temp__trade_option');
        $this->addSql('CREATE INDEX IDX_63AFBEA22576E0FD ON trade_option (contract_id)');
    }
}
