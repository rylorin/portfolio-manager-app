 ...
 */
final class Version20210528050123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD COLUMN api_req_id INTEGER DEFAULT NULL');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__stock AS SELECT id, dividend_ttm, eps_ttm, eps_forward, description, industry, category, subcategory FROM stock');
        $this->addSql('DROP TABLE stock');
        $this->addSql('CREATE TABLE stock (id INTEGER NOT NULL, dividend_ttm DOUBLE PRECISION DEFAULT NULL, eps_ttm DOUBLE PRECISION DEFAULT NULL, eps_forward DOUBLE PRECISION DEFAULT NULL, description VARCHAR(31) DEFAULT NULL COLLATE BINARY, industry VARCHAR(32) DEFAULT NULL COLLATE BINARY, category VARCHAR(32) DEFAULT NULL COLLATE BINARY, subcategory VARCHAR(32) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_4B365660BF396750 FOREIGN KEY (id) REFERENCES contract (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO stock (id, dividend_ttm, eps_ttm, eps_forward, description, industry, category, subcategory) SELECT id, dividend_ttm, eps_ttm, eps_forward, description, industry, category, subcategory FROM __temp__stock');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contract AS SELECT id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, secType FROM contract');
        $this->addSql('DROP TABLE contract');
        $this->addSql('CREATE TABLE contract (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, con_id INTEGER DEFAULT NULL, symbol VARCHAR(19) NOT NULL, currency VARCHAR(3) NOT NULL, exchange VARCHAR(8) DEFAULT NULL, name VARCHAR(31) DEFAULT NULL, fifty_two_week_low DOUBLE PRECISION DEFAULT NULL, fifty_two_week_high DOUBLE PRECISION DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, bid DOUBLE PRECISION DEFAULT NULL, ask DOUBLE PRECISION DEFAULT NULL, previous_close_price DOUBLE PRECISION DEFAULT NULL, secType VARCHAR(4) NOT NULL)');
        $this->addSql('INSERT INTO contract (id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, secType) SELECT id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, secType FROM __temp__contract');
        ...
        $this->addSql('DROP TABLE option');
        $this->addSql('CREATE TABLE option (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, stock_id INTEGER NOT NULL, last_trade_date DATE NOT NULL, strike DOUBLE PRECISION NOT NULL, call_or_put VARCHAR(1) NOT NULL, multiplier INTEGER NOT NULL, implied_volatility DOUBLE PRECISION DEFAULT NULL, delta DOUBLE PRECISION DEFAULT NULL, pv_dividend DOUBLE PRECISION DEFAULT NULL, gamma DOUBLE PRECISION DEFAULT NULL, vega DOUBLE PRECISION DEFAULT NULL, theta DOUBLE PRECISION DEFAULT NULL, api_req_id INTEGER DEFAULT NULL)');
