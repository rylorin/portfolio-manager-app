 ...
 */
final class Version20210302125154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__thread AS SELECT id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM comment__thread');
        $this->addSql('DROP TABLE comment__thread');
        $this->addSql('CREATE TABLE comment__thread (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, permalink VARCHAR(255) NOT NULL COLLATE BINARY, is_commentable BOOLEAN NOT NULL, num_comments INTEGER NOT NULL, last_comment_at DATETIME DEFAULT NULL, average_note DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO comment__thread (id, permalink, is_commentable, num_comments, last_comment_at, average_note) SELECT id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM __temp__comment__thread');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, account, base_currency, name FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER DEFAULT NULL, account VARCHAR(31) NOT NULL COLLATE BINARY, base_currency VARCHAR(3) NOT NULL COLLATE BINARY, name VARCHAR(32) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_A9ED10627E3C61F9 FOREIGN KEY (owner_id) REFERENCES fos_user_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO portfolio (id, account, base_currency, name) SELECT id, account, base_currency, name FROM __temp__portfolio');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__statement AS SELECT id, portfolio_id, stock_id, trade_unit_id, statement_type, date, currency, description, amount FROM statement');
        ...
        $this->addSql('INSERT INTO statement (id, portfolio_id, stock_id, trade_unit_id, statement_type, date, currency, description, amount) SELECT id, portfolio_id, stock_id, trade_unit_id, statement_type, date, currency, description, amount FROM __temp__statement');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade AS SELECT id, comment, price, quantity, proceeds, fees, realized_pnl, status FROM trade');
        $this->addSql('DROP TABLE trade');
        $this->addSql('CREATE TABLE trade (id INTEGER NOT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, quantity DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, status SMALLINT NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_7E1A4366BF396750 FOREIGN KEY (id) REFERENCES statement (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade (id, comment, price, quantity, proceeds, fees, realized_pnl, status) SELECT id, comment, price, quantity, proceeds, fees, realized_pnl, status FROM __temp__trade');
        $this->addSql('DROP TABLE __temp__trade');
        $this->addSql('DROP INDEX IDX_63AFBEA22576E0FD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_option AS SELECT id, contract_id, proceeds, fees, quantity, realized_pnl, comment, price, status FROM trade_option');
        $this->addSql('DROP TABLE trade_option');
        $this->addSql('CREATE TABLE trade_option (id INTEGER NOT NULL, contract_id INTEGER NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, quantity DOUBLE PRECISION NOT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, status SMALLINT NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_63AFBEA22576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_63AFBEA2BF396750 FOREIGN KEY (id) REFERENCES statement (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade_option (id, contract_id, proceeds, fees, quantity, realized_pnl, comment, price, status) SELECT id, contract_id, proceeds, fees, quantity, realized_pnl, comment, price, status FROM __temp__trade_option');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, portfolio_id, strategy, closing_date, status, pn_l, currency, opening_date, risk FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, strategy SMALLINT NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) DEFAULT NULL COLLATE BINARY, opening_date DATETIME DEFAULT NULL, risk INTEGER DEFAULT NULL, CONSTRAINT FK_BE407BA8C0F75674 FOREIGN KEY (symbol_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BE407BA8B96B5643 FOREIGN KEY (portfolio_id) REFERENCES portfolio (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, portfolio_id, strategy, closing_date, status, pn_l, currency, opening_date, risk) SELECT id, symbol_id, portfolio_id, strategy, closing_date, status, pn_l, currency, opening_date, risk FROM __temp__trade_unit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__comment AS SELECT id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private FROM comment__comment');
        $this->addSql('DROP TABLE comment__comment');
        $this->addSql('CREATE TABLE comment__comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, thread_id INTEGER DEFAULT NULL, body CLOB NOT NULL, ancestors VARCHAR(1024) NOT NULL, depth INTEGER NOT NULL, created_at DATETIME NOT NULL, state INTEGER NOT NULL, author_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, note DOUBLE PRECISION DEFAULT NULL, private BOOLEAN DEFAULT NULL)');
        $this->addSql('INSERT INTO comment__comment (id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private) SELECT id, thread_id, body, ancestors, depth, created_at, state, author_name, email, website, note, private FROM __temp__comment__comment');
        $this->addSql('DROP TABLE __temp__comment__comment');
        $this->addSql('CREATE INDEX IDX_FD78D017E2904019 ON comment__comment (thread_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__thread AS SELECT id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM comment__thread');
        $this->addSql('DROP TABLE comment__thread');
        $this->addSql('CREATE TABLE comment__thread (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, permalink VARCHAR(255) NOT NULL, is_commentable BOOLEAN NOT NULL, num_comments INTEGER NOT NULL, last_comment_at DATETIME DEFAULT NULL, average_note DOUBLE PRECISION DEFAULT NULL, category_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO comment__thread (id, permalink, is_commentable, num_comments, last_comment_at, average_note) SELECT id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM __temp__comment__thread');
        $this->addSql('DROP TABLE __temp__comment__thread');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, account, base_currency, name FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, account VARCHAR(31) NOT NULL, base_currency VARCHAR(3) NOT NULL, name VARCHAR(32) DEFAULT NULL)');
        $this->addSql('INSERT INTO portfolio (id, account, base_currency, name) SELECT id, account, base_currency, name FROM __temp__portfolio');
        $this->addSql('DROP TABLE __temp__portfolio');
        $this->addSql('DROP INDEX IDX_462CE4F5B96B5643');
        $this->addSql('DROP INDEX IDX_462CE4F52576E0FD');
        ...
        $this->addSql('DROP INDEX IDX_C0DB5176DCD6110');
        $this->addSql('DROP INDEX IDX_C0DB5176B3D28FB');
        $this->addSql('CREATE TEMPORARY TABLE __temp__statement AS SELECT id, portfolio_id, stock_id, trade_unit_id, date, currency, amount, description, statement_type FROM statement');
        $this->addSql('DROP TABLE statement');
        $this->addSql('CREATE TABLE statement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER NOT NULL, stock_id INTEGER DEFAULT NULL, trade_unit_id INTEGER DEFAULT NULL, date DATETIME NOT NULL, currency VARCHAR(3) NOT NULL, amount DOUBLE PRECISION NOT NULL, description VARCHAR(64) DEFAULT NULL, statement_type VARCHAR(4) NOT NULL)');
        $this->addSql('INSERT INTO statement (id, portfolio_id, stock_id, trade_unit_id, date, currency, amount, description, statement_type) SELECT id, portfolio_id, stock_id, trade_unit_id, date, currency, amount, description, statement_type FROM __temp__statement');
        $this->addSql('DROP TABLE __temp__statement');
        $this->addSql('CREATE INDEX IDX_C0DB5176B96B5643 ON statement (portfolio_id)');
        $this->addSql('CREATE INDEX IDX_C0DB5176DCD6110 ON statement (stock_id)');
        $this->addSql('CREATE INDEX IDX_C0DB5176B3D28FB ON statement (trade_unit_id)');
        ...
        $this->addSql('INSERT INTO tax (id, country) SELECT id, country FROM __temp__tax');
        $this->addSql('DROP TABLE __temp__tax');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade AS SELECT id, quantity, price, proceeds, fees, realized_pnl, comment, status FROM trade');
        $this->addSql('DROP TABLE trade');
        $this->addSql('CREATE TABLE trade (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, status SMALLINT NOT NULL)');
        $this->addSql('INSERT INTO trade (id, quantity, price, proceeds, fees, realized_pnl, comment, status) SELECT id, quantity, price, proceeds, fees, realized_pnl, comment, status FROM __temp__trade');
        $this->addSql('DROP TABLE __temp__trade');
        $this->addSql('DROP INDEX IDX_63AFBEA22576E0FD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_option AS SELECT id, contract_id, quantity, price, proceeds, fees, realized_pnl, comment, status FROM trade_option');
        $this->addSql('DROP TABLE trade_option');
        ...
        $this->addSql('INSERT INTO trade_option (id, contract_id, quantity, price, proceeds, fees, realized_pnl, comment, status) SELECT id, contract_id, quantity, price, proceeds, fees, realized_pnl, comment, status FROM __temp__trade_option');
        $this->addSql('DROP TABLE __temp__trade_option');
        $this->addSql('CREATE INDEX IDX_63AFBEA22576E0FD ON trade_option (contract_id)');
        $this->addSql('DROP INDEX IDX_BE407BA8C0F75674');
        $this->addSql('DROP INDEX IDX_BE407BA8B96B5643');
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency, risk FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, strategy SMALLINT NOT NULL, opening_date DATETIME DEFAULT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) DEFAULT NULL, risk DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency, risk) SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency, risk FROM __temp__trade_unit');
        $this->addSql('DROP TABLE __temp__trade_unit');
        $this->addSql('CREATE INDEX IDX_BE407BA8C0F75674 ON trade_unit (symbol_id)');
        $this->addSql('CREATE INDEX IDX_BE407BA8B96B5643 ON trade_unit (portfolio_id)');
    }
