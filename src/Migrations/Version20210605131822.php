 ...
 */
final class Version20210605131822 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, owner_id, benchmark_id, account, base_currency, name, put_ratio FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER DEFAULT NULL, benchmark_id INTEGER DEFAULT NULL, account VARCHAR(31) NOT NULL, base_currency VARCHAR(3) NOT NULL, name VARCHAR(32) DEFAULT NULL, put_ratio SMALLINT DEFAULT NULL)');
        $this->addSql('INSERT INTO portfolio (id, owner_id, benchmark_id, account, base_currency, name, put_ratio) SELECT id, owner_id, benchmark_id, account, base_currency, name, put_ratio FROM __temp__portfolio');
        $this->addSql('DROP TABLE __temp__portfolio');
        $this->addSql('CREATE INDEX IDX_A9ED10627E3C61F9 ON portfolio (owner_id)');
        $this->addSql('CREATE INDEX IDX_A9ED1062E80D127B ON portfolio (benchmark_id)');
