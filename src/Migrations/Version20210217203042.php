 ...
 */
final class Version20210217203042 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, strategy SMALLINT NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) DEFAULT NULL COLLATE BINARY, opening_date DATETIME DEFAULT NULL, risk DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_BE407BA8C0F75674 FOREIGN KEY (symbol_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BE407BA8B96B5643 FOREIGN KEY (portfolio_id) REFERENCES portfolio (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency) SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency FROM __temp__trade_unit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, strategy SMALLINT NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) DEFAULT NULL, opening_date DATETIME NOT NULL)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency) SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l, currency FROM __temp__trade_unit');
        $this->addSql('DROP TABLE __temp__trade_unit');
        $this->addSql('CREATE INDEX IDX_BE407BA8C0F75674 ON trade_unit (symbol_id)');
        $this->addSql('CREATE INDEX IDX_BE407BA8B96B5643 ON trade_unit (portfolio_id)');
