 ...
 */
final class Version20210515100059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__open_order AS SELECT id, account_id, contract_id, perm_id, client_id, order_id, action_type, total_qty, cash_qty, lmt_price, aux_price, status FROM open_order');
        $this->addSql('DROP TABLE open_order');
        $this->addSql('CREATE TABLE open_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, account_id INTEGER NOT NULL, contract_id INTEGER NOT NULL, perm_id INTEGER NOT NULL, client_id INTEGER NOT NULL, order_id INTEGER NOT NULL, action_type VARCHAR(4) NOT NULL COLLATE BINARY, total_qty DOUBLE PRECISION DEFAULT NULL, cash_qty DOUBLE PRECISION DEFAULT NULL, lmt_price DOUBLE PRECISION DEFAULT NULL, aux_price DOUBLE PRECISION DEFAULT NULL, status VARCHAR(16) NOT NULL COLLATE BINARY, remaining_qty DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_BE94B39E9B6B5FBA FOREIGN KEY (account_id) REFERENCES portfolio (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BE94B39E2576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO open_order (id, account_id, contract_id, perm_id, client_id, order_id, action_type, total_qty, cash_qty, lmt_price, aux_price, status) SELECT id, account_id, contract_id, perm_id, client_id, order_id, action_type, total_qty, cash_qty, lmt_price, aux_price, status FROM __temp__open_order');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__open_order AS SELECT id, account_id, contract_id, perm_id, client_id, order_id, action_type, total_qty, cash_qty, lmt_price, aux_price, status FROM open_order');
        $this->addSql('DROP TABLE open_order');
        $this->addSql('CREATE TABLE open_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, account_id INTEGER NOT NULL, contract_id INTEGER NOT NULL, perm_id INTEGER NOT NULL, client_id INTEGER NOT NULL, order_id INTEGER NOT NULL, action_type VARCHAR(4) NOT NULL, total_qty DOUBLE PRECISION DEFAULT NULL, cash_qty DOUBLE PRECISION DEFAULT NULL, lmt_price DOUBLE PRECISION DEFAULT NULL, aux_price DOUBLE PRECISION DEFAULT NULL, status VARCHAR(16) NOT NULL)');
        $this->addSql('INSERT INTO open_order (id, account_id, contract_id, perm_id, client_id, order_id, action_type, total_qty, cash_qty, lmt_price, aux_price, status) SELECT id, account_id, contract_id, perm_id, client_id, order_id, action_type, total_qty, cash_qty, lmt_price, aux_price, status FROM __temp__open_order');
        $this->addSql('DROP TABLE __temp__open_order');
        $this->addSql('CREATE INDEX IDX_BE94B39E9B6B5FBA ON open_order (account_id)');
        $this->addSql('CREATE INDEX IDX_BE94B39E2576E0FD ON open_order (contract_id)');
