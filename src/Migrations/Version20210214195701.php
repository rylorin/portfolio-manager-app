 ...
 */
final class Version20210214195701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, strategy SMALLINT NOT NULL, opening_date DATETIME NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) DEFAULT NULL, CONSTRAINT FK_BE407BA8C0F75674 FOREIGN KEY (symbol_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BE407BA8B96B5643 FOREIGN KEY (portfolio_id) REFERENCES portfolio (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l) SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l FROM __temp__trade_unit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment__thread AS SELECT id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM comment__thread');
        $this->addSql('DROP TABLE comment__thread');
        $this->addSql('CREATE TABLE comment__thread (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER DEFAULT NULL, permalink VARCHAR(255) NOT NULL, is_commentable BOOLEAN NOT NULL, num_comments INTEGER NOT NULL, last_comment_at DATETIME DEFAULT NULL, average_note DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO comment__thread (id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note) SELECT id, category_id, permalink, is_commentable, num_comments, last_comment_at, average_note FROM __temp__comment__thread');
        $this->addSql('DROP TABLE __temp__comment__thread');
        $this->addSql('CREATE INDEX IDX_3B60C91012469DE2 ON comment__thread (category_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__dividend AS SELECT id, country FROM dividend');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, portfolio_id INTEGER DEFAULT NULL, strategy SMALLINT NOT NULL, opening_date DATETIME NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l) SELECT id, symbol_id, portfolio_id, strategy, opening_date, closing_date, status, pn_l FROM __temp__trade_unit');
        $this->addSql('DROP TABLE __temp__trade_unit');
        $this->addSql('CREATE INDEX IDX_BE407BA8C0F75674 ON trade_unit (symbol_id)');
        $this->addSql('CREATE INDEX IDX_BE407BA8B96B5643 ON trade_unit (portfolio_id)');
