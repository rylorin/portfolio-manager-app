 ...
 */
final class Version20210130174631 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE portfolio ADD COLUMN name VARCHAR(32) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_3963EF9AC4663E4 ON page__snapshot (page_id)');
        $this->addSql('CREATE INDEX idx_snapshot_dates_enabled ON page__snapshot (publication_date_start, publication_date_end, enabled)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, account, base_currency FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, account VARCHAR(31) NOT NULL, base_currency VARCHAR(3) NOT NULL)');
        $this->addSql('INSERT INTO portfolio (id, account, base_currency) SELECT id, account, base_currency FROM __temp__portfolio');
