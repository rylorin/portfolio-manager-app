 ...
 */
final class Version20210609175350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD COLUMN updated DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contract AS SELECT id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, api_req_id, secType FROM contract');
        $this->addSql('DROP TABLE contract');
        $this->addSql('CREATE TABLE contract (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, con_id INTEGER DEFAULT NULL, symbol VARCHAR(19) NOT NULL, currency VARCHAR(3) NOT NULL, exchange VARCHAR(8) DEFAULT NULL, name VARCHAR(31) DEFAULT NULL, fifty_two_week_low DOUBLE PRECISION DEFAULT NULL, fifty_two_week_high DOUBLE PRECISION DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, bid DOUBLE PRECISION DEFAULT NULL, ask DOUBLE PRECISION DEFAULT NULL, previous_close_price DOUBLE PRECISION DEFAULT NULL, api_req_id INTEGER DEFAULT NULL, secType VARCHAR(4) NOT NULL)');
        $this->addSql('INSERT INTO contract (id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, api_req_id, secType) SELECT id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, api_req_id, secType FROM __temp__contract');
