 ...
 */
final class Version20210428085440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__statement AS SELECT id, portfolio_id, stock_id, trade_unit_id, statement_type, date, currency, description, amount, trade_id FROM statement');
        ...
        $this->addSql('INSERT INTO statement (id, portfolio_id, stock_id, trade_unit_id, statement_type, date, currency, description, amount, trade_id) SELECT id, portfolio_id, stock_id, trade_unit_id, statement_type, date, currency, description, amount, trade_id FROM __temp__statement');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C0DB5176DCD6110');
        $this->addSql('DROP INDEX IDX_C0DB5176B3D28FB');
        $this->addSql('CREATE TEMPORARY TABLE __temp__statement AS SELECT id, portfolio_id, stock_id, trade_unit_id, date, currency, amount, description, trade_id, statement_type FROM statement');
        $this->addSql('DROP TABLE statement');
        $this->addSql('CREATE TABLE statement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER NOT NULL, stock_id INTEGER DEFAULT NULL, trade_unit_id INTEGER DEFAULT NULL, date DATETIME NOT NULL, currency VARCHAR(3) NOT NULL, amount DOUBLE PRECISION NOT NULL, description VARCHAR(64) DEFAULT NULL, trade_id INTEGER DEFAULT NULL, statement_type VARCHAR(4) NOT NULL)');
        $this->addSql('INSERT INTO statement (id, portfolio_id, stock_id, trade_unit_id, date, currency, amount, description, trade_id, statement_type) SELECT id, portfolio_id, stock_id, trade_unit_id, date, currency, amount, description, trade_id, statement_type FROM __temp__statement');
        $this->addSql('DROP TABLE __temp__statement');
        $this->addSql('CREATE INDEX IDX_C0DB5176B96B5643 ON statement (portfolio_id)');
        $this->addSql('CREATE INDEX IDX_C0DB5176DCD6110 ON statement (stock_id)');
        $this->addSql('CREATE INDEX IDX_C0DB5176B3D28FB ON statement (trade_unit_id)');
