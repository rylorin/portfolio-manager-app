 ...
 */
final class Version20210210115543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trade (id INTEGER NOT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, quantity DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, status SMALLINT DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_7E1A4366BF396750 FOREIGN KEY (id) REFERENCES statement (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, strategy, opening_date, closing_date, status, pn_l FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, strategy SMALLINT NOT NULL, opening_date DATETIME NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_BE407BA8C0F75674 FOREIGN KEY (symbol_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, strategy, opening_date, closing_date, status, pn_l) SELECT id, symbol_id, strategy, opening_date, closing_date, status, pn_l FROM __temp__trade_unit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, symbol_id, strategy, opening_date, closing_date, status, pn_l FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symbol_id INTEGER NOT NULL, strategy SMALLINT NOT NULL, opening_date DATETIME NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO trade_unit (id, symbol_id, strategy, opening_date, closing_date, status, pn_l) SELECT id, symbol_id, strategy, opening_date, closing_date, status, pn_l FROM __temp__trade_unit');
        $this->addSql('DROP TABLE __temp__trade_unit');
        $this->addSql('CREATE INDEX IDX_BE407BA8C0F75674 ON trade_unit (symbol_id)');
    }
