 ...
 */
final class Version20210728173500 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, owner_id, benchmark_id, account, base_currency, name, put_ratio, sell_naked_put_sleep, find_symbols_sleep, adjust_cash_sleep, roll_options_sleep FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER DEFAULT NULL, benchmark_id INTEGER DEFAULT NULL, account VARCHAR(31) NOT NULL COLLATE BINARY, base_currency VARCHAR(3) NOT NULL COLLATE BINARY, name VARCHAR(32) DEFAULT NULL COLLATE BINARY, put_ratio DOUBLE PRECISION DEFAULT NULL, sell_naked_put_sleep SMALLINT DEFAULT NULL, find_symbols_sleep SMALLINT DEFAULT NULL, adjust_cash_sleep SMALLINT DEFAULT NULL, roll_options_sleep SMALLINT DEFAULT NULL, min_premium DOUBLE PRECISION DEFAULT NULL, naked_put_win_ratio DOUBLE PRECISION DEFAULT NULL, naked_call_win_ratio DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_A9ED10627E3C61F9 FOREIGN KEY (owner_id) REFERENCES fos_user_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A9ED1062E80D127B FOREIGN KEY (benchmark_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO portfolio (id, owner_id, benchmark_id, account, base_currency, name, put_ratio, sell_naked_put_sleep, find_symbols_sleep, adjust_cash_sleep, roll_options_sleep) SELECT id, owner_id, benchmark_id, account, base_currency, name, put_ratio, sell_naked_put_sleep, find_symbols_sleep, adjust_cash_sleep, roll_options_sleep FROM __temp__portfolio');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE position');
        $this->addSql('CREATE TABLE position (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER DEFAULT NULL, contract_id INTEGER NOT NULL, open_date DATETIME NOT NULL, quantity DOUBLE PRECISION NOT NULL, cost DOUBLE PRECISION DEFAULT NULL)');
