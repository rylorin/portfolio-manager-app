 ...
 */
final class Version20210402063012 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE trade');
        $this->addSql('CREATE TABLE trade (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, status SMALLINT NOT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP TABLE trade_option');
        $this->addSql('CREATE TABLE trade_option (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contract_id INTEGER NOT NULL, quantity DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, proceeds DOUBLE PRECISION DEFAULT NULL, fees DOUBLE PRECISION DEFAULT NULL, realized_pnl DOUBLE PRECISION DEFAULT NULL, status SMALLINT NOT NULL, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
