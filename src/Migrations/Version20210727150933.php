 ...
 */
final class Version20210727150933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contract AS SELECT id, secType, con_id, symbol, exchange, price, currency, name, fifty_two_week_low, fifty_two_week_high, bid, ask, previous_close_price, api_req_id, updated FROM contract');
        $this->addSql('DROP TABLE contract');
        $this->addSql('CREATE TABLE contract (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, secType VARCHAR(4) NOT NULL COLLATE BINARY, con_id INTEGER DEFAULT NULL, symbol VARCHAR(19) NOT NULL COLLATE BINARY, exchange VARCHAR(8) DEFAULT NULL COLLATE BINARY, price DOUBLE PRECISION DEFAULT NULL, currency VARCHAR(3) NOT NULL COLLATE BINARY, name VARCHAR(31) DEFAULT NULL COLLATE BINARY, fifty_two_week_low DOUBLE PRECISION DEFAULT NULL, fifty_two_week_high DOUBLE PRECISION DEFAULT NULL, bid DOUBLE PRECISION DEFAULT NULL, ask DOUBLE PRECISION DEFAULT NULL, previous_close_price DOUBLE PRECISION DEFAULT NULL, api_req_id INTEGER DEFAULT NULL, updated DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO contract (id, secType, con_id, symbol, exchange, price, currency, name, fifty_two_week_low, fifty_two_week_high, bid, ask, previous_close_price, api_req_id, updated) SELECT id, secType, con_id, symbol, exchange, price, currency, name, fifty_two_week_low, fifty_two_week_high, bid, ask, previous_close_price, api_req_id, updated FROM __temp__contract');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, owner_id, benchmark_id, account, base_currency, name, put_ratio, sell_naked_put_sleep, find_symbols_sleep, adjust_cash_sleep FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER DEFAULT NULL, benchmark_id INTEGER DEFAULT NULL, account VARCHAR(31) NOT NULL COLLATE BINARY, base_currency VARCHAR(3) NOT NULL COLLATE BINARY, name VARCHAR(32) DEFAULT NULL COLLATE BINARY, put_ratio DOUBLE PRECISION DEFAULT NULL, sell_naked_put_sleep SMALLINT DEFAULT NULL, find_symbols_sleep SMALLINT DEFAULT NULL, adjust_cash_sleep SMALLINT DEFAULT NULL, roll_options_sleep SMALLINT DEFAULT NULL, CONSTRAINT FK_A9ED10627E3C61F9 FOREIGN KEY (owner_id) REFERENCES fos_user_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A9ED1062E80D127B FOREIGN KEY (benchmark_id) REFERENCES stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO portfolio (id, owner_id, benchmark_id, account, base_currency, name, put_ratio, sell_naked_put_sleep, find_symbols_sleep, adjust_cash_sleep) SELECT id, owner_id, benchmark_id, account, base_currency, name, put_ratio, sell_naked_put_sleep, find_symbols_sleep, adjust_cash_sleep FROM __temp__portfolio');
        ...
        $this->addSql('DROP INDEX UNIQ_CE33C44BDCD6110');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CE33C44BDCD6110 ON trading_parameters (stock_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_FD78D01712469DE2 ON comment__comment (category_id)');
        $this->addSql('DROP INDEX UNIQ_E98F2859ECC836F9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__contract AS SELECT id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, api_req_id, updated, secType FROM contract');
        $this->addSql('DROP TABLE contract');
        $this->addSql('CREATE TABLE contract (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, con_id INTEGER DEFAULT NULL, symbol VARCHAR(19) NOT NULL, currency VARCHAR(3) NOT NULL, exchange VARCHAR(8) DEFAULT NULL, name VARCHAR(31) DEFAULT NULL, fifty_two_week_low DOUBLE PRECISION DEFAULT NULL, fifty_two_week_high DOUBLE PRECISION DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, bid DOUBLE PRECISION DEFAULT NULL, ask DOUBLE PRECISION DEFAULT NULL, previous_close_price DOUBLE PRECISION DEFAULT NULL, api_req_id INTEGER DEFAULT NULL, secType VARCHAR(4) NOT NULL, updated DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO contract (id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, api_req_id, updated, secType) SELECT id, con_id, symbol, currency, exchange, name, fifty_two_week_low, fifty_two_week_high, price, bid, ask, previous_close_price, api_req_id, updated, secType FROM __temp__contract');
        $this->addSql('DROP TABLE __temp__contract');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E98F2859ECC836F9 ON contract (symbol)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__dividend AS SELECT id, country FROM dividend');
        $this->addSql('DROP TABLE dividend');
        ...
        $this->addSql('DROP TABLE position');
        $this->addSql('CREATE TABLE position (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER DEFAULT NULL, contract_id INTEGER NOT NULL, quantity DOUBLE PRECISION NOT NULL, cost DOUBLE PRECISION DEFAULT NULL, open_date DATE NOT NULL)');
