 ...
 */
final class Version20210204200336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, strategy, opening_date, closing_date, status, pn_l FROM trade_unit');
        ...
        $this->addSql('INSERT INTO trade_unit (id, strategy, opening_date, closing_date, status, pn_l) SELECT id, strategy, opening_date, closing_date, status, pn_l FROM __temp__trade_unit');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trade_unit AS SELECT id, strategy, opening_date, closing_date, status, pn_l FROM trade_unit');
        $this->addSql('DROP TABLE trade_unit');
        $this->addSql('CREATE TABLE trade_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, strategy SMALLINT NOT NULL, opening_date DATETIME NOT NULL, closing_date DATETIME DEFAULT NULL, status SMALLINT NOT NULL, pn_l DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO trade_unit (id, strategy, opening_date, closing_date, status, pn_l) SELECT id, strategy, opening_date, closing_date, status, pn_l FROM __temp__trade_unit');
        $this->addSql('DROP TABLE __temp__trade_unit');
    }
}
