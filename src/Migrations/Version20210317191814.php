 ...
 */
final class Version20210317191814 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, owner_id, account, base_currency, name FROM portfolio');
        ...
        $this->addSql('INSERT INTO portfolio (id, owner_id, account, base_currency, name) SELECT id, owner_id, account, base_currency, name FROM __temp__portfolio');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__portfolio AS SELECT id, owner_id, account, base_currency, name FROM portfolio');
        $this->addSql('DROP TABLE portfolio');
        $this->addSql('CREATE TABLE portfolio (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER DEFAULT NULL, account VARCHAR(31) NOT NULL, base_currency VARCHAR(3) NOT NULL, name VARCHAR(32) DEFAULT NULL)');
        $this->addSql('INSERT INTO portfolio (id, owner_id, account, base_currency, name) SELECT id, owner_id, account, base_currency, name FROM __temp__portfolio');
        $this->addSql('DROP TABLE __temp__portfolio');
        $this->addSql('CREATE INDEX IDX_A9ED10627E3C61F9 ON portfolio (owner_id)');
        $this->addSql('DROP INDEX IDX_462CE4F5B96B5643');
        ...
        $this->addSql('DROP TABLE position');
        $this->addSql('CREATE TABLE position (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, portfolio_id INTEGER DEFAULT NULL, contract_id INTEGER NOT NULL, open_date DATE NOT NULL, cost DOUBLE PRECISION DEFAULT NULL, quantity INTEGER NOT NULL)');
