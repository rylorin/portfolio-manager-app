...
(function () {
  ...
  if (window.document.getElementById('portfolio_benchmark')) {
    $('#portfolio_benchmark').select2();
  }
  if (window.document.getElementById('trade_parameter_stock')) {
    $('#trade_parameter_stock').select2();
  }
  if (window.document.getElementById('option_trade_statement_stock')) {
    $('#option_trade_statement_stock').select2();
  }
